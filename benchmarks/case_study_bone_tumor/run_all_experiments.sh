...
AGGREGATOR_SCRIPT="benchmarks/aggregate_results.py"
...
AGG_JOB=$(sbatch --parsable --partition=large --nodes=1 --dependency=afterok:$DEPENDENCY_LIST --wrap="venv/bin/python $AGGREGATOR_SCRIPT --base_dir $BASE_DIR")
